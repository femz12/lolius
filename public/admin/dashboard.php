					...
					<div class="panel panel-profile">
						<div class="clearfix">
									...
									<div class="profile-stat">
										<div class="row">
											<div class="col-md-4 stat-item">
												45 <span>No. of Items</span>
											</div>
											<div class="col-md-4 stat-item">
												15 <span>No. of Sales</span>
											</div>
											<div class="col-md-4 stat-item">
												2174 <span>No. of Visits</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>Date Join <span><?php echo $date; ?></span></li>
											<li>Mobile <span><?php echo $phone ?></span></li>
											<li>Email <span><?php echo $email; ?></span></li>
											<li>Website <span><a href="https://<?php echo $web ?>" target="_blank"><?php echo $web ?></a></span></li>
										</ul>
									</div>
									<div class="profile-info">
									...
									<div class="profile-info">
										<h4 class="heading">Business Decription</h4>
										<p><?php echo $biz_det; ?></p>
									</div>
							...
							<div class="profile-right">
								<h4 class="heading"><?php echo $name; ?>'s Awards</h4>
								<!-- AWARDS -->
								<div class="awards">
									<div class="row">
								...
								<div class="custom-tabs-line tabs-line-bottom left-aligned">
									<ul class="nav" role="tablist">
										<li class="active"><a href="#tab-bottom-left1" role="tab" data-toggle="tab">Recent Activity <span class="badge">7</span></a></li>
