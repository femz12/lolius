...
<div class="main-content">
							...
							<div class="panel">
								<div class="panel-heading">
                                   ...
                                   // $id = $_GET['id']; 
                                    ...
                                    ?>
                                    <h3 class="panel-title">List of Items </b></h3>
								</div>
								<div class="panel-body">
									<table class="table">
										...
										<tbody>
                                            ...
                                            $get_ref_dir = mysqli_query($conn, "SELECT * FROM items ORDER BY id DESC");
            ...
            ?>
                                                <td>
                                                    ...
                                                    <a href="item_detail.php?itm_id=<?php echo $rw['itm_id'] ?>" class = "btn btn-info btn-md">View Detail</a>
