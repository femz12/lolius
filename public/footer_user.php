...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-grid">
			<h3>About Us</h3>
			<p>Bizallianz.com is a multinational online retail company started in the city of Ikeja, Lagos, Nigeria. It specialises in connecting closer buyers to sellers for a swift business transaction through her website and mobile application.	</p>
		</div>
		<div class="col-md-3 footer-grid ">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="index.php">Bizallianz.com<span>  Connecting Close Buyers to Sellers Through Chat</span></a></h2>
				<p class="fo-para"></p>
				<ul class="social-fo">
				...
				<div class=" address">
					...
					<div class="col-md-4 fo-grid1">
						<p><a href="mailto:info@bizallianz.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>info@bizallianz.com</a></p>
					</div>
					<div class="clearfix"></div>
