<?php  
 ...
 if($_POST){
     ...
     $get_email = mysqli_query($conn, "SELECT * FROM business WHERE email = '$email'");
     ...
     if($get_email_count > 0){
         ...
         */
         $reg = mysqli_query($conn, "INSERT INTO business (name, email, password, salt, biz_cate, biz_offer, biz_stage, biz_loc, biz_lga, biz_addr, biz_det, web, phone, date) VALUES ('$name', '$email', '$password', 'salt', '$biz_cate', '$biz_cate',  '$biz_offer', '$real_loc', '$biz_lga', '$biz_addr', '$biz_det', '$web', '$phone', '$new')") or die(mysql_error());
        ...
        Your registeraion was successful. 
       	...
       	/*if(mail){
       		...
       		echo "Error occoured while sending a mail";
       	}*/
