...
<!--content-->
		...
		<div class="container">
            <?php 
                ...
                $search = mysqli_query($conn, "SELECT * FROM items WHERE city = '$city' AND itm_type = '$itm_type' AND itm_name LIKE '%$itm_name%'");
          ...
          <br>
			...
			<div class="container">
	   		...
	   		<div class="single-w3agile">
                <div id="picture-frame">
                    <img src="uploadz/<?php echo $row['itm_img'] ?>" data-src="uploadz/<?php echo $row['itm_img'] ?>" class="img-responsive" alt="">
		      </div>
			</div>
			</div>
			<div class="col-md-9 single-top-left ">
				...
				<?php echo $row['biz_name'];  ?>'s Store <br><br>
                    ...
                    <a class="btn btn-default pull-left">View Availability</a>
