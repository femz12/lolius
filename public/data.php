...
//$itm_id = $_GET['itm_id'];
    ...
    $get_notifications = mysqli_query($conn, "SELECT * FROM relation WHERE email = '$email' AND biz_email = '$biz_email'");
        ...
        //$itm_id = $_GET['itm_id'];
            $email = $_SESSION['email'];
		mysqli_query($conn, "INSERT INTO chat (biz_name, biz_loc, biz_addr, biz_email, itm_id,  sender, email, sender_msg, stat)VALUES('$biz_name', '$biz_loc', '$biz_addr', '$biz_email', '$itm', 'You', '$email', '$chat', '$new')");
