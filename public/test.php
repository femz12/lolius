					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown">
								...
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> HouseHold Items <b class="caret"></b></span></a>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Personal Items<b class="caret"></b></span></a>
                            	...
                            	<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Computers & Mobiles<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
							...
							<li><a href="other.php" class="hyper"><span>Other Category</span></a></li>
							<li><a href="register.php" class="hyper"><span>Become A Seller</span></a></li>
						</ul>
					</div>
					</nav>
					<!-- <div class="cart" >
...
<div class="signin-form">
	...
	<div class="container">
      ...
      <div class="form-signin" id ="register-forms">
        <h2 class="form-signin-heading">Start Chat</h2><hr />
        ...
        <!-- error will be showen here ! -->
            ...
            <div id="box">
                ...
                <button id= "button1" onClick="DeleteChat();">Delete Chat</button>
                            
                            <div id="chattext"></div><br>
