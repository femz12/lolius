...
<html>
<head>
<title>Lolius | Seller Registration</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
	<div class="container">
		...
		<h4><a href="index.php">Home</a><label>/</label>Seller Registeration</h4>
...
<!--login-->
	...
	<div class="login">
        ...
        <input type="text" class="form-control" placeholder="Business/Store Name e.g Jackson" name="name" id="name" />
           </div>
        ...
        <input type="text" class="form-control" placeholder="Business Street Name e.g No 34, Balogun" name="biz_addr" id="biz_addr" />
         ...
         <div class="form-group">  
           <input type="text" class="form-control" placeholder="Nearest Bus Stop e.g Balogun Bus Stop" name="web" id="web" />
        </div>
