...
<html>
<head>
<title>Lolius Technician Login</title>
<!-- for-mobile-apps -->
...
<script type="text/javascript" src="tech_login_script.js"></script>
...
<div class="banner-top">
	<div class="container">
		...
		<h4><a href="index.php">Home</a><label>/</label>Technician Login</h4>
...
<!--login-->
	...
	<div class="login">
        ...
        <div class="form-group">
			...
			</button> <span><a href="tech_reg.php" class="btn btn-default btn-md pull-right">SignUp Here</a></span>
        </div>
					</form>
				</div>
				<div class="forg">
