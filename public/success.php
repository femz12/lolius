...
{ 
	window.setTimeout(function(){
		...
		window.location.href = "sup_login.php";
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
                            ...
                            <li><a href="sup_reg.php" class="hyper"><span>Become A Seller</span></a></li>	         <li><a href="sup_login.php" class="hyper"><span>Seller Login</span></a></li>	               
                                
                                <?php
   /// echo "Not Logged In";
}
                            ?>	
							<li><a href="other.php" class="hyper"><span>Create Ads</span></a></li>
						</ul>
					</div>
					</nav>
					<div class="cart" >
