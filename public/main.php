				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li ><a href="dashboard.php" class="hyper "><span>Home</span></a></li>
                            <!--<li><a href="codes.html" class="hyper"> <span>Add Product</span></a></li>-->
							
							<li  class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>Add Product<b class="caret"></b></span></a>
                            ...
                            <li><a href="contact.html" class="hyper"><span>View Products</span></a></li>
