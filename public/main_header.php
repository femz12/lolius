...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<a href="index.php"><img src="images/L.png"  alt=""><br><span>Sellers & Buyers Chatting Site</span></a>
		</div>
			<div class="head-t">
				<ul class="card">
					<li><a href="about.html" ><i class="fa fa-heart" aria-hidden="true"></i>About Us</a></li>
					<li><a href="login.php" ><i class="fa fa-user" aria-hidden="true"></i>Buyer Login</a></li>
